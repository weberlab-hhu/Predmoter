...
setup(
   ...
   install_requires=["helixer @ https://github.com/weberlab-hhu/Helixer/archive/refs/heads/main.zip"],
   dependency_links=["https://github.com/weberlab-hhu/Helixer/archive/refs/heads/main.zip#egg=helixer"],
